...
const mockAlerts: Alert[] = [
  {
    ...
    description:
      "Stock level dropped below critical threshold. Only 3 days of stock remaining.",
    type: "stockout",
    severity: "critical",
    status: "active",
  ...
  },
  {
    ...
    description:
      "Inventory level is below recommended threshold. Consider reordering.",
    type: "low_stock",
    severity: "medium",
    status: "active",
  ...
  },
  {
    ...
    description:
      "Prediction accuracy for Electronics category dropped below 85%.",
...
export default function DashboardAlerts() {
  ...
  const filteredAlerts = alerts
    ...
    .filter(
      (alert) => selectedStatus === "all" || alert.status === selectedStatus,
    )
    .sort(
      (a, b) =>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <Select value={selectedType} onValueChange={setSelectedType}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="forecast_accuracy">
                        Forecast Accuracy
                      </SelectItem>
                      <SelectItem value="supplier_delay">
                        Supplier Delay
                      </SelectItem>
                      <SelectItem value="cost_increase">
                        Cost Increase
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  ...
                  {alertConfigs.map((config) => (
                    ...
                    >
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Threshold: {config.threshold} | Recipients:{" "}
