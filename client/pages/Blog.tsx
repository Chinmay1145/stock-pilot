...
export default function Blog() {
  const featuredPost = {
    ...
    excerpt:
      "Learn how AI-powered demand forecasting works, why SKU-level predictions matter, and how to implement forecasting that actually improves your bottom line.",
  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Beyond basic turnover rates: the advanced metrics that separate growing businesses from stagnant ones.",
      category: "Analytics",
      readTime: "8 min read",
      date: "Dec 12, 2024",
      author: "Alex Silva",
    ...
    },
    {
      ...
      excerpt:
        "Real-world examples of how teams reduced PO approval time from weeks to minutes using automation.",
      category: "Automation",
      readTime: "6 min read",
      date: "Dec 10, 2024",
      author: "Raj Patel",
    ...
    },
    {
      ...
      excerpt:
        "Advanced techniques for handling seasonality, trend changes, and market disruptions in your forecasts.",
      category: "Demand Forecasting",
    ...
    },
    {
      ...
      excerpt:
        "Customer lifetime value, brand reputation, and opportunity costs—calculating the true impact of stockouts.",
      category: "Strategy",
      readTime: "7 min read",
      date: "Dec 5, 2024",
      author: "Sarah Chen",
    ...
    {
      title:
        "Machine Learning vs. Traditional Forecasting: A Data-Driven Comparison",
      excerpt:
        "We analyzed 1 million SKU predictions to show you exactly when and why ML outperforms traditional methods.",
    ...
    {
      title:
        "Building Supplier Relationships for Better Lead Time Predictability",
      excerpt:
        "Communication strategies and data sharing practices that improve forecast accuracy across your supply chain.",
        ...
        <div className="container mx-auto text-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              In-depth guides, case studies, and best practices from inventory
              management experts. Learn how to eliminate stockouts and optimize
              your supply chain.
            </p>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Our most comprehensive guide to demand forecasting
            </p>
          </div>
          ...
          <Card className="max-w-2xl mx-auto text-center border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-accent/5">
            <CardHeader>
              ...
              <CardDescription className="text-lg">
                Get the latest inventory management insights, case studies, and
